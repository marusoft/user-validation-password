...
def generate_employee_password(employee_details):
  ...
  employee_random_password = str(employee_details[0][0:2] + employee_details[1][-2:-1] + get_random_str_length_five)
...
while True:
  ...
  is_pass_ok = input(str('Are you satisfied with this password. If yes enter Yes If no, please supply password'))
  pass_loop = True
